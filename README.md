...
![DOTTEE screenshot social preview](./docs/social-preview.png)
...
*   Enhanced version for TTGF26a. Adds synth noise (for drum/hat), `ui_in` used for debug, sliding rows in last section. Also has a minor audio clicks fix.
